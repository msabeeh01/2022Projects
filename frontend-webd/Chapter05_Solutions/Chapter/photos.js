...
function createminiRemove(){
   ...
   var createminiRemove = document.createTextNode("Remove Image");
   var getnewIMG = document.getElementById("newImg");

   var favdiv = document.getElementById("favimg2");
   

   favdiv.insertBefore(createminiRemove, getnewIMG);
}
